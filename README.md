...
### Прочее
- Покрытие тестами 79.5%. Из покрытия исключены мок файлы и grpc-proto сгененированные файлы. Консольная команда "make cover".
...
+ Удаление всех скачанных файлов на клиенте при выходе?
